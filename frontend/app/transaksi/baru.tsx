...
export default function TransaksiBaru() {
  ...
  const createCustomer = useMutation({
    mutationFn: () => api("/customers", { body: cForm }),
    onSuccess: (c) => { setCustomer(c); setNewCust(false); qc.invalidateQueries({ queryKey: ["customers"] }); toast.show("Pelanggan tersimpan", "success"); },
      ...
      <KeyboardAwareScrollView contentContainerStyle={{ padding: 16, paddingBottom: 140 }} keyboardShouldPersistTaps="handled" bottomOffset={120}>
        ...
        {customer ? (
          ...
          <Card>
            ...
            <Input label="Alamat" value={cForm.address} onChangeText={(v) => setCForm({ ...cForm, address: v })} testID="new-customer-address-input" />
